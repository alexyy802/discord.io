#
# discord.io documentation build configuration file, created by
...
extlinks = {
    'issue': ('https://github.com/VincentRPS/discord.io/issues/%s', 'GH-'),
}
...
htmlhelp_basename = 'discord.iodoc'
...
latex_documents = [
  ('index', 'discord.io.tex', 'discord.io Documentation',
   'VincentRPS', 'manual'),
]
...
man_pages = [
    ('index', 'discord.io', 'discord.io Documentation',
     ['VincentRPS'], 1)
]
...
texinfo_documents = [
  ('index', 'discord.io', 'discord.io Documentation',
   'VincentRPS', 'discord.io', 'One line description of project.',
   'Miscellaneous'),
]
