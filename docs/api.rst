...
The following section outlines the API of discord.io.
...
discord.io offers support for creating, editing, and executing webhooks through the :class:`Webhook` class.
