...
This is a list of Frequently Asked Questions regarding using ``discord.io`` and its extension modules. Feel free to suggest a
...
Example code can be found in the `examples folder <https://github.com/VincentRPS/discord.io/tree/master/examples>`_
in the repository.
...
`Check the background_task.py example. <https://github.com/VincentRPS/discord.io/blob/master/examples/background_task.py>`_
